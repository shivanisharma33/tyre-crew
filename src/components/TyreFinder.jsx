            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 font-['Outfit']">
                ...
                <div className="flex border-b border-gray-100 flex-wrap sm:flex-nowrap">
                    ...
                    <button 
                        ...
                        className={`w-full sm:flex-1 py-4 sm:py-6 px-4 flex items-center justify-center gap-2 sm:gap-3 transition-all font-black text-xs sm:text-sm md:text-lg uppercase tracking-tight ${activeTab === 'reg' ? 'bg-[#1E40AF] text-white' : 'bg-gray-50 text-gray-400 hover:bg-gray-100'}`}
                    >
                        <div className={`p-1.5 sm:p-2 rounded-lg ${activeTab === 'reg' ? 'bg-white/20 text-white' : 'bg-gray-200 text-gray-400'}`}>
                    ...
                    <div className="w-full lg:w-2/3 space-y-10">
                        {activeTab === 'size' ? (
                            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                                <h3 className="text-3xl font-black text-black tracking-tight uppercase italic">
                                ...
                                <form onSubmit={handleSearch} className="space-y-6">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center justify-between pt-4 gap-6">
                                        <div className="flex items-center gap-4 sm:gap-6 text-blue-600 font-black uppercase text-[10px] tracking-widest">
                            ...
                            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                                <h3 className="text-3xl font-black text-black tracking-tight uppercase italic">
                                    Tyre Size by <span className="text-[#1E40AF]">Reg Number</span>
                                </h3>
                                ...
                                <div className="space-y-6">
                                    <div className="flex flex-col md:flex-row items-end gap-6">
                                        <div className="flex-1 space-y-2 w-full">
                                            ...
                                            <div className="flex items-center gap-2 sm:gap-4 overflow-hidden">
                                                <div className="flex items-center bg-[#FFD700] border-[3px] sm:border-4 border-black rounded-lg px-3 sm:px-6 py-2 sm:py-4 font-black text-sm sm:text-xl italic text-black whitespace-nowrap shadow-sm">
                                                    BD51 SMR
                                                </div>
                                                <input 
                                                    type="text" 
                                                    placeholder="ENTER REG" 
                                                    className="flex-1 min-w-0 bg-white border-2 border-slate-100 rounded-xl px-4 sm:px-6 py-3 sm:py-4 font-bold text-sm sm:text-xl text-black focus:border-[#1E40AF] outline-none shadow-sm transition-all focus:ring-4 focus:ring-blue-100"
                                                />
                                            </div>
                                        </div>
                                        <button 
                                            className="w-full md:w-auto bg-[#1E40AF] hover:bg-blue-900 text-white px-12 py-5 rounded-2xl font-black uppercase tracking-widest text-lg shadow-xl shadow-blue-900/10 transition-all active:scale-95"
                                            disabled={searching}
                                        >
                                    ...
                                    <p className="text-xs text-gray-400 font-bold uppercase tracking-widest animate-pulse">
                                        <span className="text-blue-600">⚡</span> SECURE DVLA VEHICLE LOOKUP ENABLED
                                    </p>
                                </div>
                            </div>
                        )}
